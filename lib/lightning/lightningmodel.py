...
class LightningModel(pl.LightningModule):
    ...
    def __init__(self,
                 model_type,
                 alpha,
                 style_img_size, style_descriptor_depth, pred_kernel_size,
        ...
        if model_type == 'adain':
            ...
            self.model = AdaConvModel(style_img_size, style_descriptor_depth, pred_kernel_size)
        else:
            raise ValueError('model_type')

    def forward(self, content, style, return_embeddings=False):
        return self.model(content, style, return_embeddings=False)
